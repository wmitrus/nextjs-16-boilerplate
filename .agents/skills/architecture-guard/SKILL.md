...
For Codex, this skill changes context-loading mechanics only: inspect live structural evidence first, retrieve targeted architecture/security/runtime sources, and expand progressively when needed.
