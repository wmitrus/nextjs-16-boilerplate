...
For Codex, this skill changes context-loading mechanics only: retain high-value repository runtime/fixture invariants locally, load architecture/fixture/auth sources only when applicable, and avoid broad E2E without a concrete verification need.
