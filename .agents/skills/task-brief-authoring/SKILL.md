...
For Codex, this skill changes context-loading mechanics only: inherit stable root invariants, inspect task-relevant live evidence, use targeted repository/security guidance, and avoid broad prompt/catalogue preload.
