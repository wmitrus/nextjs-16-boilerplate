...
- this skill is the Claude-native runtime surface for the same workflow intent, alongside `.agents/skills/auth-flow-change-review-workflow/SKILL.md` as the Codex-native runtime surface for the same workflow
