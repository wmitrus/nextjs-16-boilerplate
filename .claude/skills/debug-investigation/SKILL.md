...
For Claude Code, this skill changes context-loading mechanics only: investigate the live failure first, retrieve specialist/catalogue context only after the evidence path reaches that boundary, and expand progressively when needed.
