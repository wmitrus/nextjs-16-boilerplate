...
They remain semantic authorities. For Claude Code, the `Context Loading` rules in this skill control retrieval: use targeted sections/rules instead of legacy mandatory full-file startup reads. This changes context-loading mechanics, not shared implementation or security semantics.
