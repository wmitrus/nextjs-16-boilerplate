...
- this skill is the Claude-native runtime surface for the same workflow intent, alongside `.agents/skills/incident-investigation-workflow/SKILL.md` as the Codex-native runtime surface for the same workflow
