...
- `.zenflow/workflows/repository-baseline-validation.md` remains the ZenFlow execution
  layer
- this skill is the Claude-native runtime surface for the same workflow intent, alongside `.agents/skills/repository-baseline-validation-workflow/SKILL.md` as the Codex-native runtime surface for the same workflow
