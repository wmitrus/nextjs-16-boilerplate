...
- `docs/ai/general/02 - Security & Auth Agent.md` remains the shared repository prompt
  source for the role
- this skill is the Claude-native runtime surface for that role in this repository, alongside `.agents/skills/security-auth/SKILL.md` as the Codex-native runtime surface for the same role
