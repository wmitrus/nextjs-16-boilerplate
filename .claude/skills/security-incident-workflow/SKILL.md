...
- `.zenflow/workflows/security-incident-workflow.md` remains the ZenFlow execution
  layer
- this skill is the Claude-native runtime surface for the same workflow intent, alongside `.agents/skills/security-incident-workflow/SKILL.md` as the Codex-native runtime surface for the same workflow
