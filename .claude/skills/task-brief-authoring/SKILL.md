...
- `docs/ai/general/09 - Task Brief Authoring.md` remains the shared repository prompt
  source for the role
- this skill is the Claude-native runtime surface for that role in this repository, alongside `.agents/skills/task-brief-authoring/SKILL.md` as the Codex-native runtime surface for the same role
