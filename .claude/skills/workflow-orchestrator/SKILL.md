...
- this skill is the Claude-native runtime surface for that role in this repository, alongside `.agents/skills/workflow-orchestrator/SKILL.md` as the Codex-native runtime surface for the same role
