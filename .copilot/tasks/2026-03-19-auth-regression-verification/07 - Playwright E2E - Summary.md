...
- Current Run Scope: Phase 0 readiness, Phase 1 fresh-user execution, Phase 2 targeted returning-user routing verification for AF-05 / AF-06 / AF-07 / AF-08 / AF-09 after test-contract alignment, package-level auth-matrix verification hardening, completed Phase 3 cookie/source-of-truth verification for AF-12 / AF-13 / AF-14 / AF-15, completed Phase 4 runtime-stability verification for AF-17 / AF-18 / AF-21, and completed Phase 5 re-auth and refresh verification for AF-22 / AF-23 / AF-24
- Status: COMPLETE
...
- scenarios in scope: Phase 0 prerequisites, Phase 1 `AF-01` / `AF-02` / `AF-03` / `AF-04`, targeted Phase 2 verification for `AF-05` / `AF-06` / `AF-07` / `AF-08` / `AF-09`, Phase 3 verification for `AF-12` / `AF-13` / `AF-14` / `AF-15`, Phase 4 verification for `AF-17` / `AF-18` / `AF-21`, and Phase 5 verification for `AF-22` / `AF-23` / `AF-24`
...
- scenario IDs executed: `AF-01`, `AF-02`, `AF-03`, `AF-04`, `AF-05`, `AF-06`, `AF-07`, `AF-08`, `AF-09`, `AF-12`, `AF-13`, `AF-14`, `AF-15`, `AF-17`, `AF-18`, `AF-21`, `AF-22`, `AF-23`, `AF-24`
- PASS results: `AF-01`, `AF-02`, `AF-03`, `AF-04`, `AF-05`, `AF-06`, `AF-07`, `AF-08`, `AF-09`, `AF-12`, `AF-13`, `AF-14`, `AF-15`, `AF-17`, `AF-18`, `AF-21`, `AF-22`, `AF-23`, `AF-24`
...
- evidence limitations: app-server logs remain suppressed, and Playwright does not reliably expose `Set-Cookie` headers on every redirect/server-action response, so the evidence emphasizes browser state, route settlement, and targeted runtime-signal capture
...
- what remains unverified: scenarios outside the current expanded run scope, including later matrix items after AF-24
