...
- [Testing Infrastructure](./docs/features/07%20-%20Testing%20Infrastructure.md) - Three-tier testing strategy: Unit (Vitest), Integration (MSW), and E2E (Playwright).
...
- For Neon preview branching, keep the Vercel Preview Build Command set to `pnpm db:migrate:prod && pnpm build`.
