...
export const env = createEnv({
  ...
  server: {
    ...
    LEANTIME_URL: z.url().optional(),
    LEANTIME_API_KEY: z.string().optional(),
    LEANTIME_RPC_PATH: z.string().default('api/jsonrpc'),
    LEANTIME_API_TIMEOUT_MS: z.coerce.number().int().positive().default(30000),
    LEANTIME_DEFAULT_PROJECT_ID: z.coerce.number().int().positive().optional(),
    LEANTIME_DEFAULT_AUTHOR_ID: z.coerce.number().int().positive().optional(),
    LEANTIME_DEFAULT_CLIENT_ID: z.coerce.number().int().positive().optional(),
  ...
  runtimeEnv: {
    ...
    LEANTIME_URL: process.env.LEANTIME_URL,
    LEANTIME_API_KEY: process.env.LEANTIME_API_KEY,
    LEANTIME_RPC_PATH: process.env.LEANTIME_RPC_PATH,
    LEANTIME_API_TIMEOUT_MS: process.env.LEANTIME_API_TIMEOUT_MS,
    LEANTIME_DEFAULT_PROJECT_ID: process.env.LEANTIME_DEFAULT_PROJECT_ID,
    LEANTIME_DEFAULT_AUTHOR_ID: process.env.LEANTIME_DEFAULT_AUTHOR_ID,
    LEANTIME_DEFAULT_CLIENT_ID: process.env.LEANTIME_DEFAULT_CLIENT_ID,
